...
public class ChangeNote {
    public String changeNote(String email, String pword, String friendmail, String NOTE){
        String response = "";
        try {
            HttpClient httpclient=new DefaultHttpClient();
            HttpPost httpPost=new HttpPost("http://106.54.72.253/ChangeNote");//服务器地址，指向Servlet
            ...
            params.add(new BasicNameValuePair("FRIENDNOTE",NOTE));
